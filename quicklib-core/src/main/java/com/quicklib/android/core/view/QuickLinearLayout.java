...
public abstract class QuickLinearLayout extends LinearLayoutCompat {
    @Nullable
    private Bundle arguments = null;

    public QuickLinearLayout(Context context) {
        this(context, null, 0);
    }

    public QuickLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public QuickLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
