package com.quicklib.android.calendar;
...
public abstract class MonthlyCalendarAdapter<CVH extends RecyclerView.ViewHolder, HVH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter  {
    ...
    abstract HVH onCreateHeaderViewHolder(ViewGroup parent);
    abstract CVH onCreateCellViewHolder(ViewGroup parent);
    abstract void onBindHeaderViewHolder(HVH holder, Date date);
    abstract void onBindCellViewHolder(CVH holder, Date date, boolean isDayOfMonth);
